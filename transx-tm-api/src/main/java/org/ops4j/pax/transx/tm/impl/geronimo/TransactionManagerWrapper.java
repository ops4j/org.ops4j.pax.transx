...
public class TransactionManagerWrapper extends AbstractTransactionManagerWrapper<GeronimoTransactionManager> {
    ...
    protected final Map<String, RecoverableResourceFactory> resources = new HashMap<>();
    ...
    public void registerResource(RecoverableResourceFactory resource) {
        tm.registerNamedXAResourceFactory(new NamedXAResourceFactory() {
            ...
            public NamedXAResource getNamedXAResource() throws SystemException {
                NamedResource res = resource.getResource();
    ...
    protected Transaction createTransactionWrapper() {
        return new GeronimoTransactionWrapper();
    }
