...
public class TransactionManagerWrapper extends AbstractTransactionManagerWrapper<TransactionManager> {
    ...
    protected final UserTransactionService uts;
    Map<String, RecoverableResourceFactory> resources = new HashMap<>();
    Map<RecoverableResourceFactory, XATransactionalResource> recoverables = new HashMap<>();

    public TransactionManagerWrapper() {
        this(createUts(), TransactionManagerImp.getTransactionManager());
    }

    public TransactionManagerWrapper(UserTransactionService uts, TransactionManager tm) {
        super(tm);
        this.uts = uts;
    }

    private static UserTransactionService createUts() {
