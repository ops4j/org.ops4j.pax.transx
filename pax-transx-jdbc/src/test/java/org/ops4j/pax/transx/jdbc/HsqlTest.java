...
public class HsqlTest {
    ...
    @Test
    public void testLocalTxInXa() throws Exception {
    ...
    @Test
    public void testXaInLocalTx() throws Exception {
        DataSource ds = wrap(createHsqlDataSource());
        ...
        try (Connection con = ds.getConnection()) {
            ...
            try (Connection con2 = ds.getConnection()) {
                try (PreparedStatement ps = con2.prepareStatement(INSERT_INTO_USER)) {
                    ps.setInt(1, 1);
...
//            assertNull(rs.getStatement());
    ...
    protected void doBenchPs(int psCacheSize) throws Exception {
        DataSource ds = wrap(createHsqlDataSource(), psCacheSize);
