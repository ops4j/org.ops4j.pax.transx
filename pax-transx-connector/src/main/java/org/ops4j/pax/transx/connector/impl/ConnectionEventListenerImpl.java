...
public class ConnectionEventListenerImpl implements ConnectionEventListener {
    ...
    public void connectionClosed(ConnectionEvent connectionEvent) {
        ...
        try {
            stack.returnConnection(ci, ConnectionInterceptor.ConnectionReturnAction.RETURN_HANDLE);
        } catch (Throwable e) {
            if (LOG.isLoggable(Level.FINEST)) {
    ...
    public void connectionErrorOccurred(ConnectionEvent connectionEvent) {
        ...
        if (!errorOccurred) {
            ConnectionInfo ci = new ConnectionInfo(managedConnectionInfo);
            ci.setConnectionHandle(connectionEvent.getConnectionHandle());
            stack.returnConnection(ci, ConnectionInterceptor.ConnectionReturnAction.DESTROY);
        }
    }
